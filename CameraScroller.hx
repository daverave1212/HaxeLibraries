...
/*
	...
	- CameraScroller.unlock()
	- CameraScroller.unlockHorizontal()
	- CameraScroller.unlockVertical()
	- CameraScroller.enableSmoothing()
	- CameraScroller.disableSmoothing()
		
	B) Design mode
	- Initialize it with the "Initialize camera drag..." block and choose your options
	That's it! It's all set up!
*/
